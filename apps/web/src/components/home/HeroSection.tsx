...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-20 h-20 rounded-full bg-gold-400/20 blur-xl animate-pulse-soft" />
      <div className="absolute bottom-20 right-10 w-32 h-32 rounded-full bg-brand-400/20 blur-xl animate-pulse-soft" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center pt-20">
        ...
        {/* Search Box */}
        <form onSubmit={handleSearch} className="max-w-3xl mx-auto bg-white rounded-2xl shadow-2xl p-2 mb-8">
