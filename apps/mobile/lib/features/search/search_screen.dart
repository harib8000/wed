...
const _searchCategories = <String>['All', 'Venue', 'Photography', 'Catering', 'Decor', 'Makeup', 'Music', 'Videography', 'Mehendi', 'Bridal Wear', 'Band/Music'];
const _searchCities = <String>['All', 'Hyderabad', 'Chennai'];
const _mockSearchVendors = <SearchVendor>[
  SearchVendor(id: 'v1', name: 'Royal Grand Palace', category: 'Venue', city: 'Hyderabad', rating: 4.9, price: '₹5L+ onwards', imageUrl: 'https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=800&q=80', verified: true),
  SearchVendor(id: 'v2', name: 'Srikanth Photography', category: 'Photography', city: 'Hyderabad', rating: 4.8, price: '₹80K+ onwards', imageUrl: 'https://images.unsplash.com/photo-1537633552985-df8429e8048b?w=800&q=80', verified: true),
  SearchVendor(id: 'v3', name: 'Flavours Catering', category: 'Catering', city: 'Hyderabad', rating: 4.7, price: '₹800/plate', imageUrl: 'https://images.unsplash.com/photo-1555244162-803834f70033?w=800&q=80', verified: true),
  SearchVendor(id: 'v4', name: 'Blooms & Dreams', category: 'Decor', city: 'Hyderabad', rating: 4.9, price: '₹1.5L+ onwards', imageUrl: 'https://images.unsplash.com/photo-1519741497674-611481863552?w=800&q=80', verified: true),
  SearchVendor(id: 'v5', name: 'Glow Bridal Studio', category: 'Makeup', city: 'Hyderabad', rating: 4.6, price: '₹25K+ onwards', imageUrl: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=800&q=80', verified: true),
  SearchVendor(id: 'v6', name: 'Beats & Bass DJ', category: 'Music', city: 'Hyderabad', rating: 4.5, price: '₹35K+ onwards', imageUrl: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800&q=80', verified: false),
  SearchVendor(id: 'v7', name: 'Cinematic Reels', category: 'Videography', city: 'Hyderabad', rating: 4.8, price: '₹60K+ onwards', imageUrl: 'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=800&q=80', verified: true),
  SearchVendor(id: 'v8', name: 'Mehndi by Fatima', category: 'Mehendi', city: 'Hyderabad', rating: 4.9, price: '₹8K+ onwards', imageUrl: 'https://images.unsplash.com/photo-1520854221256-17451cc331bf?w=800&q=80', verified: true),
  SearchVendor(id: 'v9', name: 'Silk Route Attire', category: 'Bridal Wear', city: 'Hyderabad', rating: 4.7, price: '₹50K+ onwards', imageUrl: 'https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=800&q=80', verified: true),
  SearchVendor(id: 'v10', name: 'Golden Bells Band', category: 'Band/Music', city: 'Chennai', rating: 4.6, price: '₹40K+ onwards', imageUrl: 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=800&q=80', verified: false),
];
