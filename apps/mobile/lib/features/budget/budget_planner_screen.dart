...
final _mockBudgetState = BudgetState(
  ...
  categories: [
    ...
    BudgetCategory(
      type: BudgetCategoryType.makeup,
      name: 'Makeup',
    ...
    BudgetCategory(
      type: BudgetCategoryType.others,
      name: 'Others',
  ...
  expenses: [
    BudgetExpense(
      id: 'b1',
      category: BudgetCategoryType.venue,
      amountPaise: 30000000,
      description: 'Advance paid to Royal Grand Palace, Kompally',
      date: DateTime(2025, 1, 12),
    ),
    BudgetExpense(
      id: 'b2',
      category: BudgetCategoryType.photography,
      amountPaise: 8500000,
      description: 'Booking amount for Srikanth Photography',
      date: DateTime(2025, 1, 25),
    ),
    BudgetExpense(
      id: 'b3',
      category: BudgetCategoryType.catering,
      amountPaise: 12000000,
      description: 'Menu tasting and token for Flavours Catering',
      date: DateTime(2025, 2, 5),
    ),
    BudgetExpense(
      id: 'b4',
      category: BudgetCategoryType.decor,
      amountPaise: 4500000,
      description: 'Haldi and reception floral design booking',
      date: DateTime(2025, 2, 18),
    ),
    BudgetExpense(
      id: 'b5',
      category: BudgetCategoryType.makeup,
      amountPaise: 1500000,
      description: 'Bridal trial and advance for Glow Bridal Studio',
      date: DateTime(2025, 2, 22),
    ),
    BudgetExpense(
      id: 'b6',
      category: BudgetCategoryType.music,
      amountPaise: 1000000,
      description: 'Sangeet DJ booking amount',
      date: DateTime(2025, 2, 28),
    ),
    BudgetExpense(
      id: 'b7',
      category: BudgetCategoryType.others,
      amountPaise: 2200000,
      description: 'Wedding invitation printing in Charminar market',
